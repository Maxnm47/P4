...
public class UCMLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ASSIGN", "IF", "ELSE", "WHILE", "RETURN", "MULT", "DIV", "PLUS", "MINUS", 
			"MOD", "AND", "OR", "EQ", "NEQ", "GT", "LT", "GTE", "LTE", "NOT", "NUM", 
			"INT_T", "FLOAT_T", "STRING_T", "BOOL_T", "INT", "FLOAT", "STRING", "STRING_BODY", 
			"ESCAPE_SEQUENCE", "UNICODE_ESCAPE", "HEX_DIGIT", "BOOL", "WS", "COMMENT", 
			"BLOCK_COMMENT", "QUESTION", "LPAREN", "RPAREN", "LCURLY", "RCURLY", 
			"SEMI", "COMMA", "COLON"
		};
	}
